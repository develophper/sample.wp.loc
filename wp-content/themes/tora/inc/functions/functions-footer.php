...
function tora_footer_credits() {
	?>
		<div class="site-info">
			<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'tora' ) ); ?>"><?php printf( esc_html__( 'Powered by %s', 'tora' ), 'TR Software Services Limited' ); ?></a>
			<span class="sep"></span>
			<?php printf( esc_html__( 'Theme: %s', 'TR Software Services Limited' )); ?>
		</div>
	<?php
}
